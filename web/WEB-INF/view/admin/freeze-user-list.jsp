            ...
            <div class="card">
              <div class="card-body">
                <div class="table-responsive">
                  <h4 class="header-title">Join Users</h4>
          ...
          <div class="col-lg-3">
            <div class="card">
              <div class="card-body">
                ...
                <h5 class="mb-3 mt-4 text-uppercase bg-light p-2"><i class="mdi mdi-account-circle me-1"></i> Personal
                  Information</h5>
                <div class="container p-0">
                  <div class="row">
                    <div class="col-6">
                      <h4 class="font-13 text-muted text-uppercase mb-1">Name :</h4>
                      <p class="mb-3">Kim woosik</p>
                    </div>
                    <div class="col-6">
                    ...
                    <div class="col-6">
                      <h4 class="font-13 text-muted text-uppercase mb-1">Contact :</h4>
                      <p class="mb-3">010-4529-9453</p>
                    </div>
                    <div class="col-6">
                      <h4 class="font-13 text-muted text-uppercase mb-1">Join Time :</h4>
                      <p class="mb-0">2022.12.12</p>
                    </div>
                    <div class="col-6">
                      <h4 class="font-13 text-muted text-uppercase mb-1">Last Logined :</h4>
                      <p class="mb-0">2022.12.12</p>
                    </div>
                  </div>
                </div>
